import{_ as c,C as n,o as a,c as o,E as p,a1 as e,b as r,w as l,a as u,a2 as d}from"./chunks/framework.NjEjlYNI.js";const B=JSON.parse('{"title":"AI 代码生成实战","description":"从需求描述到生产代码 — AI 代码生成的最佳实践与 Prompt 模板","frontmatter":{"title":"AI 代码生成实战","description":"从需求描述到生产代码 — AI 代码生成的最佳实践与 Prompt 模板","difficulty":"beginner","frequency":"high"},"headers":[],"relativePath":"ai-dev/ai-code-gen.md","filePath":"ai-dev/ai-code-gen.md"}'),g={name:"ai-dev/ai-code-gen.md"};function E(h,s,A,b,m,q){const i=n("DifficultyBadge"),t=n("Mermaid");return a(),o("div",null,[p(i,{level:"beginner"}),s[1]||(s[1]=e('<h1 id="ai-代码生成实战" tabindex="-1">AI 代码生成实战 <a class="header-anchor" href="#ai-代码生成实战" aria-label="Permalink to &quot;AI 代码生成实战&quot;">​</a></h1><h2 id="一句话解释" tabindex="-1">一句话解释 <a class="header-anchor" href="#一句话解释" aria-label="Permalink to &quot;一句话解释&quot;">​</a></h2><p>AI 代码生成不是&quot;让 AI 自动写所有代码&quot;，而是<strong>把 AI 当成一个高效的结对编程伙伴</strong>——你设计架构和做决策，AI 负责实现细节。</p><h2 id="核心流程" tabindex="-1">核心流程 <a class="header-anchor" href="#核心流程" aria-label="Permalink to &quot;核心流程&quot;">​</a></h2>',4)),(a(),r(d,null,{default:l(()=>[p(t,{id:"mermaid-14",class:"mermaid",graph:"flowchart%20TD%0A%20%20%20%20A%5B%E9%9C%80%E6%B1%82%E5%88%86%E6%9E%90%5D%20--%3E%20B%7B%E5%86%99%20Prompt%7D%0A%20%20%20%20B%20--%3E%20C%5BAI%20%E7%94%9F%E6%88%90%E4%BB%A3%E7%A0%81%5D%0A%20%20%20%20C%20--%3E%20D%5B%E5%AE%A1%E6%9F%A5%E4%BB%A3%E7%A0%81%5D%0A%20%20%20%20D%20--%3E%20E%7B%E8%B4%A8%E9%87%8F%E5%90%88%E6%A0%BC%3F%7D%0A%20%20%20%20E%20--%3E%7C%E6%98%AF%7C%20F%5B%E9%9B%86%E6%88%90%E5%88%B0%E9%A1%B9%E7%9B%AE%5D%0A%20%20%20%20E%20--%3E%7C%E5%90%A6%7C%20G%7B%E9%97%AE%E9%A2%98%E6%98%AF%3F%7D%0A%20%20%20%20G%20--%3E%7C%E6%96%B9%E5%90%91%E4%B8%8D%E5%AF%B9%7C%20B%5B%E9%87%8D%E6%96%B0%E5%86%99%20Prompt%5D%0A%20%20%20%20G%20--%3E%7C%E5%B0%8F%E9%97%AE%E9%A2%98%7C%20H%5B%E6%89%8B%E5%8A%A8%E4%BF%AE%E6%94%B9%20%2F%20%E8%A1%A5%E5%85%85%20Prompt%20%E8%BF%AD%E4%BB%A3%5D%0A%20%20%20%20H%20--%3E%20C%0A%20%20%20%20F%20--%3E%20I%5B%E8%BF%90%E8%A1%8C%E6%B5%8B%E8%AF%95%5D%0A%20%20%20%20I%20--%3E%20J%7B%E9%80%9A%E8%BF%87%3F%7D%0A%20%20%20%20J%20--%3E%7C%E5%90%A6%7C%20K%5B%E5%88%86%E6%9E%90%E5%A4%B1%E8%B4%A5%E5%8E%9F%E5%9B%A0%5D%0A%20%20%20%20K%20--%3E%20B%0A%20%20%20%20J%20--%3E%7C%E6%98%AF%7C%20L%5B%E5%AE%8C%E6%88%90%5D%0A"})]),fallback:l(()=>[...s[0]||(s[0]=[u(" Loading... ",-1)])]),_:1})),s[2]||(s[2]=e(`<h2 id="深入理解" tabindex="-1">深入理解 <a class="header-anchor" href="#深入理解" aria-label="Permalink to &quot;深入理解&quot;">​</a></h2><h3 id="_1-代码生成的最佳实践" tabindex="-1">1. 代码生成的最佳实践 <a class="header-anchor" href="#_1-代码生成的最佳实践" aria-label="Permalink to &quot;1. 代码生成的最佳实践&quot;">​</a></h3><p><strong>分步生成 &gt; 一次性生成</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>❌ 一个大 Prompt 让 AI 生成完整应用</span></span>
...
<span class="line"><span>): (...args: Parameters&lt;T&gt;) =&gt; void</span></span></code></pre></div><p>要求：</p><ul><li>覆盖正常情况、边界情况、错误情况</li><li>用 describe/it 组织</li><li>debounce 需要测试异步场景（vi.useFakeTimers）</li><li>测试代码格式规范</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
<span class="line"><span>### 3. AI 生成代码质量检查清单</span></span>
<span class="line"><span></span></span>
<span class="line"><span>| 检查项 | 说明 | 严重程度 |</span></span>
<span class="line"><span>|--------|------|---------|</span></span>
<span class="line"><span>| **类型安全** | 类型定义是否完整？有无 \`any\` 滥用？ | 🔴 必须修 |</span></span>
<span class="line"><span>| **边界情况** | 空值、undefined、极端输入是否处理？ | 🔴 必须修 |</span></span>
<span class="line"><span>| **错误处理** | try/catch、错误回退、用户提示是否完善？ | 🟡 建议修 |</span></span>
<span class="line"><span>| **性能** | 有无不必要的重渲染、重复计算、内存泄漏？ | 🟡 建议修 |</span></span>
<span class="line"><span>| **可维护性** | 命名是否清晰？逻辑是否过于复杂？ | 🟢 可选 |</span></span>
<span class="line"><span>| **安全性** | 有无 XSS 风险（dangerouslySetInnerHTML）？ | 🔴 必须修 |</span></span>
<span class="line"><span>| **依赖** | 有无引入不必要的外部库？版本是否兼容？ | 🟡 建议修 |</span></span>
<span class="line"><span>| **风格匹配** | 是否遵循项目的 ESLint/Prettier 配置？ | 🟢 可选 |</span></span>
<span class="line"><span></span></span>
<span class="line"><span>## 面试问法</span></span>
<span class="line"><span></span></span>
<span class="line"><span>- 🔥 **AI 生成的代码你敢直接用吗？怎么看质量？**</span></span>
<span class="line"><span>  - 回答框架：不敢直接→先用上面 checklist 审查（类型/边界/错误）→ 跑测试 → 手动改</span></span>
<span class="line"><span>  - 核心观点：**AI 生成代码需要开发者把关，这正是资深前端不可替代的地方**</span></span>
<span class="line"><span></span></span>
<span class="line"><span>- ⭐ **说说你的 AI 代码生成工作流？**</span></span>
<span class="line"><span>  - 分步策略：先定义接口 → 再生成核心逻辑 → 再补测试 → 最后集成</span></span>
<span class="line"><span>  - 迭代策略：先让 AI 出方案 → 审方案 → 再出代码 → 审代码 → 改 Prompt 迭代</span></span>
<span class="line"><span></span></span>
<span class="line"><span>## 💡 AI 辅助学习</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&gt; 用这个 Prompt 练习审查 AI 生成代码的能力：</span></span>
<span class="line"><span>&gt; &quot;你是一个 AI 代码生成器。请生成一个有 3-5 个隐藏问题的 React 组件（类型错误/性能问题/内存泄漏/边界情况）。然后我作为开发者来审查并指出问题，你来确认我是否找对了。&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>## 关联知识</span></span>
<span class="line"><span></span></span>
<span class="line"><span>- [Prompt 基础](./prompt-basics) — 核心 Prompt 结构</span></span>
<span class="line"><span>- [AI 调试助手](./ai-debugging) — 用 AI 排查 Bug</span></span>
<span class="line"><span>- [AI + 前端工作流](./ai-workflow) — AI 驱动的全链路开发</span></span></code></pre></div>`,24))])}const C=c(g,[["render",E]]);export{B as __pageData,C as default};
